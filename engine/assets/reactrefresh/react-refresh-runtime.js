// react-refresh-runtime.development.js (react-refresh@0.17.0)
// Copyright (c) Meta Platforms, Inc. and affiliates.
// MIT License
//
// Wrapped for Algernon HMR: exposes window.__algernonHMRRefresh and
// calls injectIntoGlobalHook(window) so the hook is installed before
// ReactDOM loads.  This script must be the first <script> in <head>.
(function(exports) {
  "use strict";
...
"production" !== process.env.NODE_ENV &&
  ...
  window.__algernonHMRRefresh = exports;
