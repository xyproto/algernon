...
* Supports [Negroni](https://github.com/codegangsta/negroni), [Iris](https://github.com/kataras/iris), [Martini](https://github.com/go-martini/martini), [Gin](https://github.com/gin-gonic/gin), [Goji](https://github.com/zenazn/goji) and plain `net/http`.
...
// in order to be compatible with not only `permissionbolt`, but also
// other database backends, like `permissions2`, which uses Redis.
