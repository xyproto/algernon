...
* Also works on 64-bit Windows 8. (Tested with Redis from [here](https://github.com/MSOpenTech/redis/releases) with this executable: [algernon.exe](https://github.com/xyproto/algernon/blob/w8/bin/algernon.exe)).
