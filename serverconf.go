 ...
 * `DenyPage(string)` creates a new page for "permission denied".
 *  Takes a message or a HTML page.
 */

// Make functions related to permissions available to server.lua
func exportServerconf(w http.ResponseWriter, req *http.Request, L *lua.LState, perm *permissions.Permissions) {
